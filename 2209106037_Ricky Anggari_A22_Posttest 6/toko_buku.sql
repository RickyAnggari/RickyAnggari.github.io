...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2023 at 04:53 PM
...
INSERT INTO `toko_buku` (`ID_Buku`, `Judul_Buku`, `Chapter`, `Harga_Buku`) VALUES
(111, 'Naruto', 100, 90000);
...
--
ALTER TABLE `toko_buku`
  MODIFY `ID_Buku` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=246;
COMMIT;
